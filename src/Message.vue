<template>
  <div class="sc-message" :class="'message_'+message.author"> 
    <div class="sc-message--content" :style="{color: colors.receivedMessage.text}" :class="{
      ...
      <slot
        ...
        :message="message"
        :user="user">
          <div v-if="message.type !== 'system' && authorName && authorName !== 'me'"  class="sc-message--avatar" :style="{
            backgroundImage: `url(${chatImageUrl})`
          }"></div>  <!-- :title="authorName" v-tooltip="authorName" -->
      </slot>
